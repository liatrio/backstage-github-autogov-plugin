...
export const columnFactories = Object.freeze({
    ...
    return {
      ...
      render: ({ entity }) => (
        <SubvalueCell
          ...
          subvalue={entity.metadata.description}
        />
      ),
    };
  },
  ...
  createSourceColumn(): TableColumn<CatalogTableRow> {
    return {
      title: 'Source',
      // backstage.io/source-location
      field: 'resolved.sourceLocation',
      emptyValue: 'Unknown',
      // hidden: false,
    };
  },
  ...
  createLatestAutoGovStatusColumn(): TableColumn<CatalogTableRow> {
    return {
      title: 'AutoGov Status (Latest Release)',
      field: 'releaseStatus',
      render: ({ entity }) => {
        const hasStatus =
          entity.metadata.annotations?.['liatrio.com/autogov-release-status'];
